...
import { CheckCircle, AlertTriangle, Download, FileSpreadsheet, FileText } from 'lucide-react';
import { WorkflowRoadmap } from '../components/WorkflowRoadmap';
import { Layout } from '../components/Layout';

export function Export() {
  const navigate = useNavigate();
  const [isReady] = useState(true); // Toggle this to see both states
  const [blockers] = useState<string[]>([
    // Example blockers when isReady is false:
        ...
        {isReady ? (
          <>
            ...
            <div className="pt-4 border-t border-[#1F2937] mt-auto">
              <button className="w-full bg-[#10B981] hover:bg-[#059669] text-white py-2 px-4 rounded text-xs font-medium flex items-center justify-center gap-2">
                <Download size={14} />
          ...
          <>
            ...
            <div className="pt-3 border-t border-[#1F2937] mt-auto">
              <button
                onClick={() => navigate('/review')}
