  ...
  const [questions] = useState<Question[]>([
    {
      ...
      status: 'Answered',
      answer: 'For equipment over $500, these should be depreciated as capital assets. The chair under $500 can be expensed immediately. Please categorize the laptop and monitor as capital purchases.',
      date: '2025-05-10'
    },
    {
      id: 2,
      ...
      <div className="flex-1 flex flex-col max-w-6xl mx-auto w-full px-6 py-4 overflow-hidden">
        <div className="mb-4">
          ...
          <p className="text-xs text-[#6B7280]">
            Questions sent to your accountant for evidence and guidance.
          </p>
        </div>
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className={`text-[10px] px-2 py-0.5 rounded border ${getStatusColor(question.status)}`}>
                      {question.status}
                    </span>
