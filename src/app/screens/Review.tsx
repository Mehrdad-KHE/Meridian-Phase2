...
import { ArrowLeft, ArrowRight, AlertCircle, FileText, TrendingUp } from 'lucide-react';
  ...
  const [reviewItems] = useState<ReviewItem[]>([
    {
      ...
      confidence: 92,
      evidence: ['All receipts from Petro-Canada', 'Transaction amounts: $45-$85', 'Dates: Jan 2-28, 2025', 'All include fuel product codes'],
    },
    {
      id: 2,
      ...
      confidence: 78,
      evidence: ['Invoice #1024 appears 3 times', 'Same amount: $1,250.00', 'Different scan quality', 'Latest scan is clearest'],
    },
    {
      id: 3,
      ...
      confidence: 45,
      evidence: ['Home office equipment purchases', 'Personal vehicle registration', 'Mixed meal receipts (business + personal)'],
    },
  ]);
        ...
        <div className="flex-1 flex flex-col max-w-6xl mx-auto w-full px-6 py-4 overflow-hidden">
          <div className="flex items-start justify-between gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#6B7280]">These items need your attention. All other documents have been automatically categorized.</p>
            </div>
            <button
          ...
          <div className="flex-1 overflow-y-auto space-y-4 mb-4">
            {reviewItems.map((item) => (
              ...
              >
                <div className="p-6 cursor-pointer hover:bg-[#252C37]/50" onClick={() => setSelectedItem(selectedItem === item.id ? null : item.id)}>
